...
{
    public NoiseGenerator _generator;
    ...
    [Range(0, 1000)] 
    public float curlDistortionFactor;
    
    [Range(0, 1)] 
    public float forwardScatteringFactor;
    [Range(0, 1)] 
    public float backwardScatteringFactor;
    [Range(0, 1)] 
    ...
    private void Start()
    {
        _shapeRt3d = _generator.ShapeRT;
        _detailRt3d = _generator.DetailRT;
    ...
    private void Update()
    {
        _weatherTex = _weatherSystem.weatherTexture;
    }
    ...
    private void UpdateCloudMaterial()
    {
        ...
        _CloudMat.SetFloat("_GlobalDensity", globalDensity);
        _CloudMat.SetFloat("_FallOffCoverage",  falloffCoverage);
        ...
        _CloudMat.SetFloat("_BackwardScattering", backwardScatteringFactor);
        ...
        _CloudMat.SetFloat("_ConeSpread", coneSpread);
        ...
        _CloudMat.SetColor("_CloudBaseColor", cloudBaseColor);
        _CloudMat.SetColor("_CloudTopColor", cloudTopColor);
        _CloudMat.SetFloat("_AmbientLightFactor", ambientLightFactor);
        _CloudMat.SetFloat("_DirectLightFactor", directLightFactor);
        ...
        _CloudMat.SetVector("_CloudHeightMinMax",  new Vector4(startHeight, startHeight + cloudThickness, cloudThickness, 0));
    }
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        UpdateCloudMaterial();
        cloudRT = RenderTexture.GetTemporary(source.width, source.height, source.depth, source.format, RenderTextureReadWrite.Default);
