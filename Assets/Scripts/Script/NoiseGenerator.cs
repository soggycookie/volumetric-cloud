...
public class NoiseGenerator : MonoBehaviour
{
    ...
    private void GenerateShapeRT()
    {
        ...
        Noise data = new Noise(
            ...
            new Vector3(shapeResolution, shapeResolution, shapeResolution), density, 1, octaves, persistence, lacunarity,
    ...
    private void GenerateDetailRT()
    {
        ...
        Noise data = new Noise(
            ...
            new Vector3(detailResolution, detailResolution, detailResolution), density, 1, octaves, persistence, lacunarity,
            Random.Range(0, 999), true, 1.0f, 1.0f);
...
public struct Noise
{
    ...
    public Noise(RenderTexture rt, EnumScript.Dimension dimension, EnumScript.NoiseType noiseType, EnumScript.ActiveChannel activeChannel, Vector3 resolution, int density, float scale, int octaves, float persistance, float lacunarity, int seed, bool isInverted, float angleOffset, float exponent)
    {
        this.rt = rt;
    ...
    public Noise(RenderTexture rt, EnumScript.Dimension dimension, EnumScript.NoiseType noiseType, Vector3 resolution, int density, float scale, int octaves, float persistance, float lacunarity, int seed, bool isInverted, float angleOffset, float exponent) : this()
    {
        this.rt = rt;
        this.dimension = dimension;
        this.noiseType = noiseType;
        ...
        this.activeChannel = EnumScript.ActiveChannel.R | EnumScript.ActiveChannel.G | EnumScript.ActiveChannel.B | EnumScript.ActiveChannel.A;
    }
}
